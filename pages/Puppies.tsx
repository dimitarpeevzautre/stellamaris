...
const PuppyLocationMap = () => {
    ...
    const locations = [
        ...
        { id: 2, country: t('puppies.locations.spain'), count: 1, lat: 40.4637, lng: -3.7492 },
        { id: 3, country: t('puppies.locations.uk'), city: t('puppies.locations.london'), count: 1, lat: 51.5074, lng: -0.1278 },
        { id: 4, country: t('puppies.locations.bulgaria'), city: t('puppies.locations.sofia'), count: 4, lat: 42.6977, lng: 23.3219 },
    ];
        ...
        <div className="min-h-screen bg-white py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-stella-sand/20 rounded-2xl p-8 flex items-start gap-4">
                    ...
                    <div>
                        <h3 className="font-bold text-lg text-stella-blue mb-2">{t('puppies.waitlist_title')}</h3>
                        <p className="text-gray-600">
                            {t('puppies.waitlist_desc')}
                        </p>
                    </div>
                </div>
            </div>
