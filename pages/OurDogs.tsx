...
const OurDogs: React.FC = () => {
  const male = DOGS.find(d => d.gender === 'Male');
  const female = DOGS.find(d => d.gender === 'Female');

  return (
    <div className="min-h-screen bg-stella-cream">
      {/* Header */}
      <div className="py-24 text-center">
        <h1 className="text-5xl font-serif text-stella-dark mb-4">Our Foundation</h1>
        ...
        <p className="text-xl text-gray-500 max-w-2xl mx-auto font-light leading-relaxed px-4">
          Meet the exceptional pair at the heart of our breeding program. Each selected for their perfect balance of health, temperament, and breed standards.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-32">
        ...
        {male && (
          <div className="flex flex-col lg:flex-row items-center gap-16 mb-32 group">
            ...
            <div className="lg:w-1/2 space-y-8">
                <div>
                    <span className="text-stella-gold font-sans text-xs font-bold tracking-[0.3em] uppercase mb-2 block">The Sire</span>
        ...
        {female && (
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16 group">
            ...
            <div className="lg:w-1/2 space-y-8">
                <div>
                    <span className="text-stella-gold font-sans text-xs font-bold tracking-[0.3em] uppercase mb-2 block text-right lg:text-left">The Dam</span>
      ...
      <section className="bg-stella-dark py-24 text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
            <p className="text-3xl font-serif italic mb-8 opacity-80 leading-relaxed">
                "Our dogs are our family. We have taken care to produce healthy, happy dogs that excel in the ring, on the field, and in your heart."
            </p>
            <div className="flex justify-center items-center gap-4">
                <div className="h-px w-12 bg-stella-gold"></div>
                <span className="text-stella-gold font-sans text-xs font-bold tracking-widest uppercase">The Stella Maris Philosophy</span>
                <div className="h-px w-12 bg-stella-gold"></div>
            </div>
        </div>
      </section>
